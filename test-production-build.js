...
const bundle = fs.readFileSync(path.join(dist, 'assets', 'arco.js'), 'utf8');

if (!html.includes('assets/arco.js')) throw new Error('Production HTML does not load the application bundle');
